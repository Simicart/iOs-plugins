//
//  SCCustomizeProductSecondDesignViewController.m
//  SimiCartPluginFW
//
...
@interface SCCustomizeProductSecondDesignViewController ()

@end

@implementation SCCustomizeProductSecondDesignViewController{
...
- (void)loginToCheckout:(UIButton *)button{
    SCCustomizeLoginViewController *loginVC = [SCCustomizeLoginViewController new];
    loginVC.product = self.product;
        ...
        if(!cell){
            ...
            if(exgstOption){
                ...
                if([stockType isEqualToString:@"4"] || !stockType){
                    ...
                    SimiLabel *stockStatusLabel = [[SimiLabel alloc]initWithFrame:CGRectMake(paddingX, cellY, tableWidth - paddingX*2, 25) andFontName:THEME_FONT_NAME_REGULAR];
