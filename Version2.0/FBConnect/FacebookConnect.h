...
@property (nonatomic, strong) SCProductViewController *productViewController;
@property (nonatomic, strong) SCProductViewController_Pad *productViewControllerPad;
...
@property (nonatomic, strong) FBLikeControl *fbLikeControl;
