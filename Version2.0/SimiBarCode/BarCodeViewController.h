...
@interface BarCodeViewController : SimiViewController<UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIAlertViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, SCProductViewController_Pad_Delegate, UIPopoverControllerDelegate>
{
