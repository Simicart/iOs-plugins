...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    self.navigationItem.title =SCLocalizedString(@"Store List View");
}
...
{
    SimiStoreLocatorDetailViewController *sLDetailViewController = [[SimiStoreLocatorDetailViewController alloc]initWithNibName:@"SimiStoreLocatorDetailViewController" bundle:nil];
