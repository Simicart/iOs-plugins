...
@property (nonatomic, strong) IBOutlet UILabel* lblStoreDistance;
@property (nonatomic, strong) IBOutlet UIImageView* imgStoreImage;
...
- (IBAction)btnMail_Click:(id)sender;
