...
@interface SimiStoreLocatorViewController_iPad ()

@end

@implementation SimiStoreLocatorViewController_iPad
{
...
- (void)btnStoreLocatorListView_Click:(id)sender
{
    ...
    if (SYSTEM_VERSION_LESS_THAN(@"7.0")) {
        sLListViewControllerPortrait.contentSizeForViewInPopover = CGSizeMake(widthListView, 800);
    }else
    {
...
- (void)showViewDetailControllerFromList:(SimiStoreLocatorModel *)sLModel_
{
    ...
    if (SYSTEM_VERSION_LESS_THAN(@"7.0")) {
        detailViewController.contentSizeForViewInPopover = CGSizeMake(SCREEN_WIDTH * 2/3, SCREEN_HEIGHT *2/3);
    }else
    {
...
{
    isDetailViewController = YES;
    detailViewController = [[SimiStoreLocatorDetailViewController alloc]initWithNibName:@"SimiStoreLocatorDetailViewController" bundle:nil];
    detailViewController.sLModel = sLModel_;
    detailViewController.currentLatitude = sLMapViewController.currentLatitube;
    detailViewController.currentLongitude = sLMapViewController.currentLongitube;
    if (SYSTEM_VERSION_LESS_THAN(@"7.0")) {
