...
@implementation SCCartCell_Theme01
...
- (void)setInterfaceCell
{
    ...
    self.nameLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", THEME01_FONT_NAME_REGULAR] size:THEME_FONT_SIZE_REGULAR];
    ...
    self.priceLabel.textColor = THEME01_PRICE_COLOR;
    self.priceLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", THEME01_FONT_NAME_REGULAR] size:THEME_FONT_SIZE_REGULAR];
    ...
    for (NSDictionary *option in [_item valueForKeyPath:@"options"]) {
        if(i < 2){
            ...
            optionNameLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", THEME01_FONT_NAME_REGULAR] size:THEME_FONT_SIZE_REGULAR];
            ...
            optionValueLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", THEME01_FONT_NAME_REGULAR] size:THEME_FONT_SIZE_REGULAR];
    ...
    qtyLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", THEME01_FONT_NAME_REGULAR] size:THEME_FONT_SIZE_REGULAR];
    ...
    self.qtyTextField.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", THEME01_FONT_NAME_REGULAR] size:THEME_FONT_SIZE_REGULAR];
    ...
    self.stockStatusLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", THEME01_FONT_NAME_REGULAR] size:THEME_FONT_SIZE_REGULAR];
