//
//  SCOptionGroupViewCell_Theme01.m
//  SimiCartPluginFW
//
...
@implementation SCOptionGroupViewCell_Theme01
...
- (void)setPriceOption:(NSDictionary*)optionDictionary
{
    ...
    int heightLabel = 15;
    int heightLabelWidthDistance = 20;
    
    int boldTag = 1010;
    int thinTag = 1020;
    int redTag = 1030;
    
    originY += heightLabelWidthDistance/2;
    ...
    for (UIView *subview in self.subviews) {
        if ([subview isKindOfClass:[UILabel class]]) {
            ...
            if (lblView.tag == boldTag) {
                [lblView setFont:[UIFont fontWithName:THEME_FONT_NAME size:THEME_FONT_SIZE_REGULAR]];
