//
//  SCOrderViewControllerPad_Theme01.m
//  SimiCartPluginFW
//
...
@interface SCOrderViewControllerPad_Theme01 ()
{
    BOOL accept;
...
@implementation SCOrderViewControllerPad_Theme01
...
{
    if (_tableLeft == nil) {
        _tableLeft = [[UITableView alloc]initWithFrame:CGRectMake(0, 20, 500, 670) style:UITableViewStyleGrouped];
    ...
    if (_tableRight == nil) {
        _tableRight = [[UITableView alloc]initWithFrame:CGRectMake(524, 20, 500, 670) style:UITableViewStyleGrouped];
...
- (void)configOrderTableLeft
{
    ...
    [_orderTableLeft addSectionWithIdentifier:ORDER_SHIPMENT_SECTION];
    ...
    if (tableView.tag == 1000) {
        if (self.orderTableLeft) {
                    ...
                    switch (indexPath.row) {
                        case 0:{
                            ...
                            if (_billingAddress != nil) {
                                ...
                                userLabel.font = [UIFont fontWithName:THEME01_FONT_NAME_LIGHT size:18.0];
                                ...
                                addressLabel.font = [UIFont fontWithName:THEME01_FONT_NAME_LIGHT size:18.0];
            ...
            if ([simiSection.identifier isEqualToString:ORDER_PAYMENT_SECTION]) {
                ...
                UILabel *lblContentPayment = [[UILabel alloc]initWithFrame:CGRectMake(60, 40, 430, 40)];
                [lblContentPayment setFont:[UIFont fontWithName:THEME01_FONT_NAME_LIGHT size:14]];
                ...
                UILabel *paymentTitleLabel = [[UILabel alloc]initWithFrame:CGRectMake(60, 5, 430, 30)];
                paymentTitleLabel.text = paymentTitle;
                paymentTitleLabel.font = [UIFont fontWithName:THEME01_FONT_NAME_LIGHT size:18.0];
        ...
        if (self.orderTableRight) {
            ...
            if ([simiSection.identifier isEqualToString:ORDER_TOTALS_SECTION]) {
                if(indexPath.row < [_cart count]){
                    ...
                    NSString *CartCellIdentifier = [NSString stringWithFormat:@"%@_%@",@"SCCartCellIdentifier",[item valueForKeyPath:@"cart_item_id"]];
                    ...
                    if (_isRequestOrderConfig) {
                        ...
                        [(SCOrderFeeCell *)cell setIsUsePhoneSizeOnPad:YES];
            ...
            if ([simiSection.identifier isEqualToString:ORDER_COUPON_SECTION]) {
                ...
                if (cell == nil) {
                    ...
                    if (_textFieldCouponCode == nil) {
                        ...
                        CGRect frame = CGRectMake(15, 15, 450, 40);
                        ...
                        [_textFieldCouponCode setFont:[UIFont fontWithName:THEME01_FONT_NAME_BOLD size:16]];
                        [_textFieldCouponCode setTextColor:[UIColor blackColor]];
                        //  Liam Update RTL
                        if ([[SimiGlobalVar sharedInstance]isReverseLanguage]) {
                            [_textFieldCouponCode setTextAlignment:NSTextAlignmentRight];
                        }
                        //  End RTL
                    }
            ...
            if ([simiSection.identifier isEqualToString:ORDER_BUTTON_SECTION]) {
                ...
                button.titleLabel.font = [UIFont fontWithName:THEME01_FONT_NAME_REGULAR size:24];
...
- (UIView *) tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    [headerTitleSection setFont:[UIFont fontWithName:THEME01_FONT_NAME_BOLD size:18]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView.tag == 1000) {
        if (self.orderTableLeft) {
            ...
            if ([simiSection.identifier isEqualToString:ORDER_SHIPMENT_SECTION]) {
                SCShippingViewControllerPad_Theme01 *nextController = [[SCShippingViewControllerPad_Theme01 alloc]init];
