...
@implementation ZThemeCartCellPad
...
- (void)setInterfaceCell
{
    ...
    [productImageView setFrame:CGRectMake(imageX, _heightCell - 5, 220, 260)];
    ...
    [_productBackgroundImage setImage:[UIImage imageNamed:@"Ztheme_cartbackgroundimageproduct"]];
    ...
    nameLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", ZTHEME_FONT_NAME_REGULAR] size:THEME_FONT_SIZE];
    ...
    priceLabel.textColor = ZTHEME_PRICE_COLOR;
    priceLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", ZTHEME_FONT_NAME_REGULAR] size:20];
    ...
    for (NSDictionary *option in [_item valueForKeyPath:@"options"]) {
        if(i < 2){
            ...
            optionNameLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", ZTHEME_FONT_NAME_REGULAR] size:THEME_FONT_SIZE];
            ...
            optionValueLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", ZTHEME_FONT_NAME_REGULAR] size:THEME_FONT_SIZE];
    ...
    qtyLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", ZTHEME_FONT_NAME_REGULAR] size:THEME_FONT_SIZE];
    ...
    qtyTextField.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", ZTHEME_FONT_NAME_REGULAR] size:THEME_FONT_SIZE];
    ...
    stockStatusLabel.font = [UIFont fontWithName:[NSString stringWithFormat:@"%@", ZTHEME_FONT_NAME_REGULAR] size:THEME_FONT_SIZE];
