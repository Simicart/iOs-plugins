//
//  ZThemeScreenBeforeOrderViewControllerPad.m
//  SimiCartPluginFW
//
...
@interface ZThemeScreenBeforeOrderViewControllerPad ()
{
...
@implementation ZThemeScreenBeforeOrderViewControllerPad
    ...
    if (isEnableGuestCheckout) {
        switch (buttonIndex) {
            case 0: //Checkout as existing customer
            {
                ...
                ZThemeLoginViewController *nextController = [[ZThemeLoginViewController alloc] init];
