//
//  SCPThankYouPageViewController.m
//  SimiCartPluginFW
//
...
#import "SCPThankYouPageViewController.h"

@interface SCPThankYouPageViewController ()

@end

@implementation SCPThankYouPageViewController
...
- (UITableViewCell *)contentTableViewCellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(!cell){
        ...
        if([row.identifier isEqualToString:THANK_YOU_PAGE_TITLE_ROW]){
            ...
            cell.heightCell += CGRectGetHeight(viewDetailButton.frame);
        }else if([row.identifier isEqualToString:THANK_YOU_PAGE_BUTTON_ROW]){
            cell.heightCell = 20;
            SCPButton *continueButton = [[SCPButton alloc] initWithFrame:CGRectMake(paddingX, cell.heightCell, contentWidth, buttonHeight) title:@"CONTINUE SHOPPING" titleFont:[UIFont fontWithName:SCP_FONT_SEMIBOLD size:FONT_SIZE_LARGE] cornerRadius:buttonHeight/2 borderWidth:0 borderColor:[UIColor blackColor]];
