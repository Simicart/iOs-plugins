...
//    [[SCAppController sharedInstance] openURL:[NSString stringWithFormat:@"%@%@", kBaseURL,@"simiconnector/customchat/index"] withNavigationController:GLOBALVAR.currentlyNavigationController];
    SCCustomChatViewController *customchatViewController = [SCCustomChatViewController new];
    [GLOBALVAR.currentlyNavigationController pushViewController:customchatViewController animated:YES];
