...
- (void)setUpSearchVoiceView {
    ...
    // recording image
    self.recordingButton = [[UIButton alloc] initWithFrame:SCALEFRAME(CGRectMake((SCREEN_WIDTH - 100)/2, (SCREEN_HEIGHT - 100) / 2, 100, 100))];
    ...
    // status label
    self.recordStatusLb = [[UILabel alloc] initWithFrame:SCALEFRAME(CGRectMake(8, self.recordingButton.frame.origin.y - 8 - SCALEVALUE(50), SCREEN_WIDTH - 16, 50))];
    ...
    // close button
    self.recordCloseBtn = [[UIButton alloc] initWithFrame:SCALEFRAME(CGRectMake((SCREEN_WIDTH - 30)/2, SCREEN_HEIGHT - 8 - 30, 30, 30))];
    // try record btn
    self.tryRecordBtn = [[UIButton alloc] initWithFrame:SCALEFRAME(CGRectMake(((SCREEN_WIDTH / 2) - 50)/2, (SCREEN_HEIGHT - 50) / 2, 50, 50))];
    ...
    self.tryRecordLb = [[UILabel alloc] initWithFrame:SCALEFRAME(CGRectMake(8, self.tryRecordBtn.frame.origin.y + 50, (SCREEN_WIDTH / 2) - 16, 20))];
    ...
    // search text btn
    self.searchTextBtn = [[UIButton alloc] initWithFrame:SCALEFRAME(CGRectMake(((SCREEN_WIDTH / 2) - 50)/2 + (SCREEN_WIDTH/2), (SCREEN_HEIGHT - 50) / 2, 50, 50))];
    ...
    self.searchTextLb = [[UILabel alloc] initWithFrame:SCALEFRAME(CGRectMake((SCREEN_WIDTH /2) + 8, self.tryRecordBtn.frame.origin.y + 50, (SCREEN_WIDTH / 2) - 16, 20))];
