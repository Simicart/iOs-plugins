...
- (void)setUpSearchVoiceView {
    // recording view
    // add backgroundView
    UIView *backGroundView = [[UIView alloc] initWithFrame:[SimiGlobalVar scaleFrame:CGRectMake(0, 0, 320, 640)]];
    backGroundView.backgroundColor = [UIColor blackColor];
    backGroundView.alpha = 0.9;
    [self.view addSubview:backGroundView];
    // recording image
    self.recordingButton = [[UIButton alloc] initWithFrame:[SimiGlobalVar scaleFrame:CGRectMake((320 - 100)/2, (480 - 100) / 2, 100, 100)]];
    ...
    // status label
    self.recordStatusLb = [[UILabel alloc] initWithFrame:[SimiGlobalVar scaleFrame:CGRectMake(8, self.recordingButton.frame.origin.y - 8 - [SimiGlobalVar scaleValue:50], 320 - 16, 50)]];
    self.recordStatusLb.text = @"Say something to looking for...";
    self.recordStatusLb.textColor = [UIColor whiteColor];
    [self.recordStatusLb setTextAlignment:(NSTextAlignmentCenter)];
    // close button
    self.recordCloseBtn = [[UIButton alloc] initWithFrame:[SimiGlobalVar scaleFrame:CGRectMake((320 - 30)/2, 480 - 8 - 30, 30, 30)]];
    // try record btn
    self.tryRecordBtn = [[UIButton alloc] initWithFrame:[SimiGlobalVar scaleFrame:CGRectMake(((320 / 2) - 50)/2, (480 - 50) / 2, 50, 50)]];
    ...
    self.tryRecordLb = [[UILabel alloc] initWithFrame:[SimiGlobalVar scaleFrame:CGRectMake(8, self.tryRecordBtn.frame.origin.y + 50, (320 / 2) - 16, 20)]];
    ...
    self.tryRecordLb.hidden = YES;
    // search text btn
    self.searchTextBtn = [[UIButton alloc] initWithFrame:[SimiGlobalVar scaleFrame:CGRectMake(((320 / 2) - 50)/2 + (320/2), (480 - 50) / 2, 50, 50)]];
    ...
    self.searchTextLb = [[UILabel alloc] initWithFrame:[SimiGlobalVar scaleFrame:CGRectMake((320 /2) + 8, self.tryRecordBtn.frame.origin.y + 50, (320 / 2) - 16, 20)]];
